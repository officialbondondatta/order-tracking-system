...
const TrackYourOrder = () => {
    return (
        <section className="container mx-auto max-w-300 lg:mt-10 md:mt-10 bg-indigo-50 p-5 rounded-2xl">
            {/* Common Header */}
            ...
            <div className="grid lg:grid-cols-12 grid-cols-1 gap-5">
                {/* Left side */}
                <div className="lg:col-span-7 bg-green-50 p-5 py-8 rounded-xl">
